...
import { Transaction, assignGroupID, makeApplicationCreateTxnFromObject, getApplicationAddress, makeApplicationCallTxnFromObject, makeAssetTransferTxnWithSuggestedParamsFromObject, makePaymentTxnWithSuggestedParamsFromObject, makeApplicationDeleteTxnFromObject } from 'algosdk'
...
export const buildTransactionBuyEscrow = async (
    ...
    try {
        ...
        const buyTxn = makeApplicationCallTxnFromObject({
            ...
            onComplete: 0,
            appArgs: [
                new Uint8Array(Buffer.from('on_buy')),
                uint64ToBigEndian(qty)
            ],
